...
override PKGDIR = xconfig_Swi_thread
...
package/%.xdc.inc package/%_xconfig_Swi_thread.c package/%.defs.h: %.xdc $(PKGCFGS)
	@$(MSG) generating interfaces for package xconfig_Swi_thread" (because $@ is older than $(firstword $?))" ...
	$(XSRUN) -f xdc/services/intern/cmd/build.xs $(MK_IDLOPTS) -m package/package.xdc.dep -i package/package.xdc.inc package.xdc

.dlls,em4f .dlls: Swi_thread.pem4f

-include package/cfg/Swi_thread_pem4f.mak
-include package/cfg/Swi_thread_pem4f.cfg.mak
ifeq (,$(MK_NOGENDEPS))
-include package/cfg/Swi_thread_pem4f.dep
endif
Swi_thread.pem4f: package/cfg/Swi_thread_pem4f.xdl
	@


ifeq (,$(wildcard .libraries,em4f))
Swi_thread.pem4f package/cfg/Swi_thread_pem4f.c: .libraries,em4f
endif

package/cfg/Swi_thread_pem4f.c package/cfg/Swi_thread_pem4f.h package/cfg/Swi_thread_pem4f.xdl: override _PROG_NAME := Swi_thread.xem4f
package/cfg/Swi_thread_pem4f.c: package/cfg/Swi_thread_pem4f.cfg
package/cfg/Swi_thread_pem4f.xdc.inc: package/cfg/Swi_thread_pem4f.xdl
package/cfg/Swi_thread_pem4f.xdl package/cfg/Swi_thread_pem4f.c: .interfaces

clean:: clean,em4f
	-$(RM) package/cfg/Swi_thread_pem4f.cfg
	-$(RM) package/cfg/Swi_thread_pem4f.dep
	-$(RM) package/cfg/Swi_thread_pem4f.c
	-$(RM) package/cfg/Swi_thread_pem4f.xdc.inc

clean,em4f::
	-$(RM) Swi_thread.pem4f
.executables,em4f .executables: Swi_thread.xem4f

Swi_thread.xem4f: |Swi_thread.pem4f

-include package/cfg/Swi_thread.xem4f.mak
Swi_thread.xem4f: package/cfg/Swi_thread_pem4f.oem4f 
	$(RM) $@
	@$(MSG) lnkem4f $@ ...
	$(RM) $(XDCCFGDIR)/$@.map
	$(ti.targets.arm.elf.M4F.rootDir)/bin/armcl -fs $(XDCCFGDIR)$(dir $@). -q -u _c_int00 --silicon_version=7M4 -z --strict_compatibility=on  -o $@ package/cfg/Swi_thread_pem4f.oem4f   package/cfg/Swi_thread_pem4f.xdl  -w -c -m $(XDCCFGDIR)/$@.map -l $(ti.targets.arm.elf.M4F.rootDir)/lib/libc.a
	
Swi_thread.xem4f: export C_DIR=
Swi_thread.xem4f: PATH:=$(ti.targets.arm.elf.M4F.rootDir)/bin/;$(PATH)
Swi_thread.xem4f: Path:=$(ti.targets.arm.elf.M4F.rootDir)/bin/;$(PATH)

Swi_thread.test test,em4f test: Swi_thread.xem4f.test

Swi_thread.xem4f.test:: Swi_thread.xem4f
ifeq (,$(_TESTLEVEL))
	@$(MAKE) -R -r --no-print-directory -f $(XDCROOT)/packages/xdc/bld/xdc.mak _TESTLEVEL=1 Swi_thread.xem4f.test
else
	@$(MSG) running $<  ...
	$(call EXEC.Swi_thread.xem4f, ) 
endif

clean,em4f::
	-$(RM) $(wildcard .tmp,Swi_thread.xem4f,*)
...
%,copy:
	...
	$(RM) $@
	$(CP) $< $@
Swi_thread_pem4f.oem4f,copy : package/cfg/Swi_thread_pem4f.oem4f
Swi_thread_pem4f.sem4f,copy : package/cfg/Swi_thread_pem4f.sem4f

$(XDCCFGDIR)%.c $(XDCCFGDIR)%.h $(XDCCFGDIR)%.xdl: $(XDCCFGDIR)%.cfg $(XDCROOT)/packages/xdc/cfg/Main.xs | .interfaces
	@$(MSG) "configuring $(_PROG_NAME) from $< ..."
	$(CONFIG) $(_PROG_XSOPTS) xdc.cfg $(_PROG_NAME) $(XDCCFGDIR)$*.cfg $(XDCCFGDIR)$*

.PHONY: release,xconfig_Swi_thread
ifeq (,$(MK_NOGENDEPS))
-include package/rel/xconfig_Swi_thread.tar.dep
endif
package/rel/xconfig_Swi_thread/xconfig_Swi_thread/package/package.rel.xml: package/package.bld.xml
package/rel/xconfig_Swi_thread/xconfig_Swi_thread/package/package.rel.xml: package/build.cfg
package/rel/xconfig_Swi_thread/xconfig_Swi_thread/package/package.rel.xml: package/package.xdc.inc
package/rel/xconfig_Swi_thread/xconfig_Swi_thread/package/package.rel.xml: .force
	@$(MSG) generating external release references $@ ...
	$(XS) $(JSENV) -f $(XDCROOT)/packages/xdc/bld/rel.js $(MK_RELOPTS) . $@

xconfig_Swi_thread.tar: package/rel/xconfig_Swi_thread.xdc.inc package/rel/xconfig_Swi_thread/xconfig_Swi_thread/package/package.rel.xml
	@$(MSG) making release file $@ "(because of $(firstword $?))" ...
	-$(RM) $@
	$(call MKRELTAR,package/rel/xconfig_Swi_thread.xdc.inc,package/rel/xconfig_Swi_thread.tar.dep)


release release,xconfig_Swi_thread: all xconfig_Swi_thread.tar
clean:: .clean
	-$(RM) xconfig_Swi_thread.tar
	-$(RM) package/rel/xconfig_Swi_thread.xdc.inc
	-$(RM) package/rel/xconfig_Swi_thread.tar.dep
