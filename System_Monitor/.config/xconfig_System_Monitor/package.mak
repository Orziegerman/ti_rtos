...
override PKGDIR = xconfig_System_Monitor
...
package/%.xdc.inc package/%_xconfig_System_Monitor.c package/%.defs.h: %.xdc $(PKGCFGS)
	@$(MSG) generating interfaces for package xconfig_System_Monitor" (because $@ is older than $(firstword $?))" ...
	$(XSRUN) -f xdc/services/intern/cmd/build.xs $(MK_IDLOPTS) -m package/package.xdc.dep -i package/package.xdc.inc package.xdc

.dlls,em4f .dlls: System_Monitor.pem4f

-include package/cfg/System_Monitor_pem4f.mak
-include package/cfg/System_Monitor_pem4f.cfg.mak
ifeq (,$(MK_NOGENDEPS))
-include package/cfg/System_Monitor_pem4f.dep
endif
System_Monitor.pem4f: package/cfg/System_Monitor_pem4f.xdl
	@


ifeq (,$(wildcard .libraries,em4f))
System_Monitor.pem4f package/cfg/System_Monitor_pem4f.c: .libraries,em4f
endif

package/cfg/System_Monitor_pem4f.c package/cfg/System_Monitor_pem4f.h package/cfg/System_Monitor_pem4f.xdl: override _PROG_NAME := System_Monitor.xem4f
package/cfg/System_Monitor_pem4f.c: package/cfg/System_Monitor_pem4f.cfg
package/cfg/System_Monitor_pem4f.xdc.inc: package/cfg/System_Monitor_pem4f.xdl
package/cfg/System_Monitor_pem4f.xdl package/cfg/System_Monitor_pem4f.c: .interfaces

clean:: clean,em4f
	-$(RM) package/cfg/System_Monitor_pem4f.cfg
	-$(RM) package/cfg/System_Monitor_pem4f.dep
	-$(RM) package/cfg/System_Monitor_pem4f.c
	-$(RM) package/cfg/System_Monitor_pem4f.xdc.inc

clean,em4f::
	-$(RM) System_Monitor.pem4f
.executables,em4f .executables: System_Monitor.xem4f

System_Monitor.xem4f: |System_Monitor.pem4f

-include package/cfg/System_Monitor.xem4f.mak
System_Monitor.xem4f: package/cfg/System_Monitor_pem4f.oem4f 
	$(RM) $@
	@$(MSG) lnkem4f $@ ...
	$(RM) $(XDCCFGDIR)/$@.map
	$(ti.targets.arm.elf.M4F.rootDir)/bin/armcl -fs $(XDCCFGDIR)$(dir $@). -q -u _c_int00 --silicon_version=7M4 -z --strict_compatibility=on  -o $@ package/cfg/System_Monitor_pem4f.oem4f   package/cfg/System_Monitor_pem4f.xdl  -w -c -m $(XDCCFGDIR)/$@.map -l $(ti.targets.arm.elf.M4F.rootDir)/lib/libc.a
	
System_Monitor.xem4f: export C_DIR=
System_Monitor.xem4f: PATH:=$(ti.targets.arm.elf.M4F.rootDir)/bin/;$(PATH)
System_Monitor.xem4f: Path:=$(ti.targets.arm.elf.M4F.rootDir)/bin/;$(PATH)

System_Monitor.test test,em4f test: System_Monitor.xem4f.test

System_Monitor.xem4f.test:: System_Monitor.xem4f
ifeq (,$(_TESTLEVEL))
	@$(MAKE) -R -r --no-print-directory -f $(XDCROOT)/packages/xdc/bld/xdc.mak _TESTLEVEL=1 System_Monitor.xem4f.test
else
	@$(MSG) running $<  ...
	$(call EXEC.System_Monitor.xem4f, ) 
endif

clean,em4f::
	-$(RM) $(wildcard .tmp,System_Monitor.xem4f,*)


clean:: clean,em4f

clean,em4f::
	-$(RM) System_Monitor.xem4f
%,copy:
	@$(if $<,,$(MSG) don\'t know how to build $*; exit 1)
	@$(MSG) cp $< $@
	$(RM) $@
	$(CP) $< $@
System_Monitor_pem4f.oem4f,copy : package/cfg/System_Monitor_pem4f.oem4f
System_Monitor_pem4f.sem4f,copy : package/cfg/System_Monitor_pem4f.sem4f

$(XDCCFGDIR)%.c $(XDCCFGDIR)%.h $(XDCCFGDIR)%.xdl: $(XDCCFGDIR)%.cfg $(XDCROOT)/packages/xdc/cfg/Main.xs | .interfaces
	@$(MSG) "configuring $(_PROG_NAME) from $< ..."
	$(CONFIG) $(_PROG_XSOPTS) xdc.cfg $(_PROG_NAME) $(XDCCFGDIR)$*.cfg $(XDCCFGDIR)$*

.PHONY: release,xconfig_System_Monitor
ifeq (,$(MK_NOGENDEPS))
-include package/rel/xconfig_System_Monitor.tar.dep
endif
package/rel/xconfig_System_Monitor/xconfig_System_Monitor/package/package.rel.xml: package/package.bld.xml
package/rel/xconfig_System_Monitor/xconfig_System_Monitor/package/package.rel.xml: package/build.cfg
package/rel/xconfig_System_Monitor/xconfig_System_Monitor/package/package.rel.xml: package/package.xdc.inc
package/rel/xconfig_System_Monitor/xconfig_System_Monitor/package/package.rel.xml: .force
	@$(MSG) generating external release references $@ ...
	$(XS) $(JSENV) -f $(XDCROOT)/packages/xdc/bld/rel.js $(MK_RELOPTS) . $@

xconfig_System_Monitor.tar: package/rel/xconfig_System_Monitor.xdc.inc package/rel/xconfig_System_Monitor/xconfig_System_Monitor/package/package.rel.xml
	@$(MSG) making release file $@ "(because of $(firstword $?))" ...
	-$(RM) $@
	$(call MKRELTAR,package/rel/xconfig_System_Monitor.xdc.inc,package/rel/xconfig_System_Monitor.tar.dep)


release release,xconfig_System_Monitor: all xconfig_System_Monitor.tar
clean:: .clean
	-$(RM) xconfig_System_Monitor.tar
	-$(RM) package/rel/xconfig_System_Monitor.xdc.inc
	-$(RM) package/rel/xconfig_System_Monitor.tar.dep
