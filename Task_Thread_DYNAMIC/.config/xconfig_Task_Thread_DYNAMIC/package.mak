...
override PKGDIR = xconfig_Task_Thread_DYNAMIC
...
package/%.xdc.inc package/%_xconfig_Task_Thread_DYNAMIC.c package/%.defs.h: %.xdc $(PKGCFGS)
	@$(MSG) generating interfaces for package xconfig_Task_Thread_DYNAMIC" (because $@ is older than $(firstword $?))" ...
	$(XSRUN) -f xdc/services/intern/cmd/build.xs $(MK_IDLOPTS) -m package/package.xdc.dep -i package/package.xdc.inc package.xdc

.dlls,em4f .dlls: Task_Thread_DYNAMIC.pem4f

-include package/cfg/Task_Thread_DYNAMIC_pem4f.mak
-include package/cfg/Task_Thread_DYNAMIC_pem4f.cfg.mak
ifeq (,$(MK_NOGENDEPS))
-include package/cfg/Task_Thread_DYNAMIC_pem4f.dep
endif
Task_Thread_DYNAMIC.pem4f: package/cfg/Task_Thread_DYNAMIC_pem4f.xdl
	@


ifeq (,$(wildcard .libraries,em4f))
Task_Thread_DYNAMIC.pem4f package/cfg/Task_Thread_DYNAMIC_pem4f.c: .libraries,em4f
endif

package/cfg/Task_Thread_DYNAMIC_pem4f.c package/cfg/Task_Thread_DYNAMIC_pem4f.h package/cfg/Task_Thread_DYNAMIC_pem4f.xdl: override _PROG_NAME := Task_Thread_DYNAMIC.xem4f
package/cfg/Task_Thread_DYNAMIC_pem4f.c: package/cfg/Task_Thread_DYNAMIC_pem4f.cfg
package/cfg/Task_Thread_DYNAMIC_pem4f.xdc.inc: package/cfg/Task_Thread_DYNAMIC_pem4f.xdl
package/cfg/Task_Thread_DYNAMIC_pem4f.xdl package/cfg/Task_Thread_DYNAMIC_pem4f.c: .interfaces

clean:: clean,em4f
	-$(RM) package/cfg/Task_Thread_DYNAMIC_pem4f.cfg
	-$(RM) package/cfg/Task_Thread_DYNAMIC_pem4f.dep
	-$(RM) package/cfg/Task_Thread_DYNAMIC_pem4f.c
	-$(RM) package/cfg/Task_Thread_DYNAMIC_pem4f.xdc.inc

clean,em4f::
	-$(RM) Task_Thread_DYNAMIC.pem4f
.executables,em4f .executables: Task_Thread_DYNAMIC.xem4f

Task_Thread_DYNAMIC.xem4f: |Task_Thread_DYNAMIC.pem4f

-include package/cfg/Task_Thread_DYNAMIC.xem4f.mak
Task_Thread_DYNAMIC.xem4f: package/cfg/Task_Thread_DYNAMIC_pem4f.oem4f 
	$(RM) $@
	@$(MSG) lnkem4f $@ ...
	$(RM) $(XDCCFGDIR)/$@.map
	$(ti.targets.arm.elf.M4F.rootDir)/bin/armcl -fs $(XDCCFGDIR)$(dir $@). -q -u _c_int00 --silicon_version=7M4 -z --strict_compatibility=on  -o $@ package/cfg/Task_Thread_DYNAMIC_pem4f.oem4f   package/cfg/Task_Thread_DYNAMIC_pem4f.xdl  -w -c -m $(XDCCFGDIR)/$@.map -l $(ti.targets.arm.elf.M4F.rootDir)/lib/libc.a
	
Task_Thread_DYNAMIC.xem4f: export C_DIR=
Task_Thread_DYNAMIC.xem4f: PATH:=$(ti.targets.arm.elf.M4F.rootDir)/bin/;$(PATH)
Task_Thread_DYNAMIC.xem4f: Path:=$(ti.targets.arm.elf.M4F.rootDir)/bin/;$(PATH)

Task_Thread_DYNAMIC.test test,em4f test: Task_Thread_DYNAMIC.xem4f.test

Task_Thread_DYNAMIC.xem4f.test:: Task_Thread_DYNAMIC.xem4f
ifeq (,$(_TESTLEVEL))
	@$(MAKE) -R -r --no-print-directory -f $(XDCROOT)/packages/xdc/bld/xdc.mak _TESTLEVEL=1 Task_Thread_DYNAMIC.xem4f.test
else
	@$(MSG) running $<  ...
	$(call EXEC.Task_Thread_DYNAMIC.xem4f, ) 
endif

clean,em4f::
	-$(RM) $(wildcard .tmp,Task_Thread_DYNAMIC.xem4f,*)


clean:: clean,em4f

clean,em4f::
	-$(RM) Task_Thread_DYNAMIC.xem4f
%,copy:
	@$(if $<,,$(MSG) don\'t know how to build $*; exit 1)
	@$(MSG) cp $< $@
	$(RM) $@
	$(CP) $< $@
Task_Thread_DYNAMIC_pem4f.oem4f,copy : package/cfg/Task_Thread_DYNAMIC_pem4f.oem4f
Task_Thread_DYNAMIC_pem4f.sem4f,copy : package/cfg/Task_Thread_DYNAMIC_pem4f.sem4f

$(XDCCFGDIR)%.c $(XDCCFGDIR)%.h $(XDCCFGDIR)%.xdl: $(XDCCFGDIR)%.cfg $(XDCROOT)/packages/xdc/cfg/Main.xs | .interfaces
	@$(MSG) "configuring $(_PROG_NAME) from $< ..."
	$(CONFIG) $(_PROG_XSOPTS) xdc.cfg $(_PROG_NAME) $(XDCCFGDIR)$*.cfg $(XDCCFGDIR)$*

.PHONY: release,xconfig_Task_Thread_DYNAMIC
ifeq (,$(MK_NOGENDEPS))
-include package/rel/xconfig_Task_Thread_DYNAMIC.tar.dep
endif
package/rel/xconfig_Task_Thread_DYNAMIC/xconfig_Task_Thread_DYNAMIC/package/package.rel.xml: package/package.bld.xml
package/rel/xconfig_Task_Thread_DYNAMIC/xconfig_Task_Thread_DYNAMIC/package/package.rel.xml: package/build.cfg
package/rel/xconfig_Task_Thread_DYNAMIC/xconfig_Task_Thread_DYNAMIC/package/package.rel.xml: package/package.xdc.inc
package/rel/xconfig_Task_Thread_DYNAMIC/xconfig_Task_Thread_DYNAMIC/package/package.rel.xml: .force
	@$(MSG) generating external release references $@ ...
	$(XS) $(JSENV) -f $(XDCROOT)/packages/xdc/bld/rel.js $(MK_RELOPTS) . $@

xconfig_Task_Thread_DYNAMIC.tar: package/rel/xconfig_Task_Thread_DYNAMIC.xdc.inc package/rel/xconfig_Task_Thread_DYNAMIC/xconfig_Task_Thread_DYNAMIC/package/package.rel.xml
	@$(MSG) making release file $@ "(because of $(firstword $?))" ...
	-$(RM) $@
	$(call MKRELTAR,package/rel/xconfig_Task_Thread_DYNAMIC.xdc.inc,package/rel/xconfig_Task_Thread_DYNAMIC.tar.dep)


release release,xconfig_Task_Thread_DYNAMIC: all xconfig_Task_Thread_DYNAMIC.tar
clean:: .clean
	-$(RM) xconfig_Task_Thread_DYNAMIC.tar
	-$(RM) package/rel/xconfig_Task_Thread_DYNAMIC.xdc.inc
	-$(RM) package/rel/xconfig_Task_Thread_DYNAMIC.tar.dep
