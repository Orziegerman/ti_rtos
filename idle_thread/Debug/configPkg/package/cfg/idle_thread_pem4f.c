...
/* --> ledController */
extern xdc_Void ledController(xdc_Void);
 ...
 */
xdc__META(__ASM__, "@(#)__ASM__ = C:/Users/ArieZaleski/projects/ti_rtos/idle_thread/Debug/configPkg/package/cfg/idle_thread_pem4f");
...
const __T1_ti_sysbios_knl_Idle_funcList ti_sysbios_knl_Idle_funcList__A[2] = {
    ((xdc_Void(*)(xdc_Void))((xdc_Fxn)ledController)),  /* [0] */
