...
override PKGDIR = xconfig_idle_thread
...
package/%.xdc.inc package/%_xconfig_idle_thread.c package/%.defs.h: %.xdc $(PKGCFGS)
	@$(MSG) generating interfaces for package xconfig_idle_thread" (because $@ is older than $(firstword $?))" ...
	$(XSRUN) -f xdc/services/intern/cmd/build.xs $(MK_IDLOPTS) -m package/package.xdc.dep -i package/package.xdc.inc package.xdc

.dlls,em4f .dlls: idle_thread.pem4f

-include package/cfg/idle_thread_pem4f.mak
-include package/cfg/idle_thread_pem4f.cfg.mak
ifeq (,$(MK_NOGENDEPS))
-include package/cfg/idle_thread_pem4f.dep
endif
idle_thread.pem4f: package/cfg/idle_thread_pem4f.xdl
	@


ifeq (,$(wildcard .libraries,em4f))
idle_thread.pem4f package/cfg/idle_thread_pem4f.c: .libraries,em4f
endif

package/cfg/idle_thread_pem4f.c package/cfg/idle_thread_pem4f.h package/cfg/idle_thread_pem4f.xdl: override _PROG_NAME := idle_thread.xem4f
package/cfg/idle_thread_pem4f.c: package/cfg/idle_thread_pem4f.cfg
package/cfg/idle_thread_pem4f.xdc.inc: package/cfg/idle_thread_pem4f.xdl
package/cfg/idle_thread_pem4f.xdl package/cfg/idle_thread_pem4f.c: .interfaces

clean:: clean,em4f
	-$(RM) package/cfg/idle_thread_pem4f.cfg
	-$(RM) package/cfg/idle_thread_pem4f.dep
	-$(RM) package/cfg/idle_thread_pem4f.c
	-$(RM) package/cfg/idle_thread_pem4f.xdc.inc

clean,em4f::
	-$(RM) idle_thread.pem4f
.executables,em4f .executables: idle_thread.xem4f

idle_thread.xem4f: |idle_thread.pem4f

-include package/cfg/idle_thread.xem4f.mak
idle_thread.xem4f: package/cfg/idle_thread_pem4f.oem4f 
	$(RM) $@
	@$(MSG) lnkem4f $@ ...
	$(RM) $(XDCCFGDIR)/$@.map
	$(ti.targets.arm.elf.M4F.rootDir)/bin/armcl -fs $(XDCCFGDIR)$(dir $@). -q -u _c_int00 --silicon_version=7M4 -z --strict_compatibility=on  -o $@ package/cfg/idle_thread_pem4f.oem4f   package/cfg/idle_thread_pem4f.xdl  -w -c -m $(XDCCFGDIR)/$@.map -l $(ti.targets.arm.elf.M4F.rootDir)/lib/libc.a
	
idle_thread.xem4f: export C_DIR=
idle_thread.xem4f: PATH:=$(ti.targets.arm.elf.M4F.rootDir)/bin/;$(PATH)
idle_thread.xem4f: Path:=$(ti.targets.arm.elf.M4F.rootDir)/bin/;$(PATH)

idle_thread.test test,em4f test: idle_thread.xem4f.test

idle_thread.xem4f.test:: idle_thread.xem4f
ifeq (,$(_TESTLEVEL))
	@$(MAKE) -R -r --no-print-directory -f $(XDCROOT)/packages/xdc/bld/xdc.mak _TESTLEVEL=1 idle_thread.xem4f.test
else
	@$(MSG) running $<  ...
	$(call EXEC.idle_thread.xem4f, ) 
endif

clean,em4f::
	-$(RM) $(wildcard .tmp,idle_thread.xem4f,*)


clean:: clean,em4f

clean,em4f::
	-$(RM) idle_thread.xem4f
%,copy:
	@$(if $<,,$(MSG) don\'t know how to build $*; exit 1)
	@$(MSG) cp $< $@
	$(RM) $@
	$(CP) $< $@
idle_thread_pem4f.oem4f,copy : package/cfg/idle_thread_pem4f.oem4f
idle_thread_pem4f.sem4f,copy : package/cfg/idle_thread_pem4f.sem4f

$(XDCCFGDIR)%.c $(XDCCFGDIR)%.h $(XDCCFGDIR)%.xdl: $(XDCCFGDIR)%.cfg $(XDCROOT)/packages/xdc/cfg/Main.xs | .interfaces
	@$(MSG) "configuring $(_PROG_NAME) from $< ..."
	$(CONFIG) $(_PROG_XSOPTS) xdc.cfg $(_PROG_NAME) $(XDCCFGDIR)$*.cfg $(XDCCFGDIR)$*

.PHONY: release,xconfig_idle_thread
ifeq (,$(MK_NOGENDEPS))
-include package/rel/xconfig_idle_thread.tar.dep
endif
package/rel/xconfig_idle_thread/xconfig_idle_thread/package/package.rel.xml: package/package.bld.xml
package/rel/xconfig_idle_thread/xconfig_idle_thread/package/package.rel.xml: package/build.cfg
package/rel/xconfig_idle_thread/xconfig_idle_thread/package/package.rel.xml: package/package.xdc.inc
package/rel/xconfig_idle_thread/xconfig_idle_thread/package/package.rel.xml: .force
	@$(MSG) generating external release references $@ ...
	$(XS) $(JSENV) -f $(XDCROOT)/packages/xdc/bld/rel.js $(MK_RELOPTS) . $@

xconfig_idle_thread.tar: package/rel/xconfig_idle_thread.xdc.inc package/rel/xconfig_idle_thread/xconfig_idle_thread/package/package.rel.xml
	@$(MSG) making release file $@ "(because of $(firstword $?))" ...
	-$(RM) $@
	$(call MKRELTAR,package/rel/xconfig_idle_thread.xdc.inc,package/rel/xconfig_idle_thread.tar.dep)


release release,xconfig_idle_thread: all xconfig_idle_thread.tar
clean:: .clean
	-$(RM) xconfig_idle_thread.tar
	-$(RM) package/rel/xconfig_idle_thread.xdc.inc
	-$(RM) package/rel/xconfig_idle_thread.tar.dep
