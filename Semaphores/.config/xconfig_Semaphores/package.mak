...
override PKGDIR = xconfig_Semaphores
...
package/%.xdc.inc package/%_xconfig_Semaphores.c package/%.defs.h: %.xdc $(PKGCFGS)
	@$(MSG) generating interfaces for package xconfig_Semaphores" (because $@ is older than $(firstword $?))" ...
	$(XSRUN) -f xdc/services/intern/cmd/build.xs $(MK_IDLOPTS) -m package/package.xdc.dep -i package/package.xdc.inc package.xdc

.dlls,em4f .dlls: Semaphores.pem4f

-include package/cfg/Semaphores_pem4f.mak
-include package/cfg/Semaphores_pem4f.cfg.mak
ifeq (,$(MK_NOGENDEPS))
-include package/cfg/Semaphores_pem4f.dep
endif
Semaphores.pem4f: package/cfg/Semaphores_pem4f.xdl
	@


ifeq (,$(wildcard .libraries,em4f))
Semaphores.pem4f package/cfg/Semaphores_pem4f.c: .libraries,em4f
endif

package/cfg/Semaphores_pem4f.c package/cfg/Semaphores_pem4f.h package/cfg/Semaphores_pem4f.xdl: override _PROG_NAME := Semaphores.xem4f
package/cfg/Semaphores_pem4f.c: package/cfg/Semaphores_pem4f.cfg
package/cfg/Semaphores_pem4f.xdc.inc: package/cfg/Semaphores_pem4f.xdl
package/cfg/Semaphores_pem4f.xdl package/cfg/Semaphores_pem4f.c: .interfaces

clean:: clean,em4f
	-$(RM) package/cfg/Semaphores_pem4f.cfg
	-$(RM) package/cfg/Semaphores_pem4f.dep
	-$(RM) package/cfg/Semaphores_pem4f.c
	-$(RM) package/cfg/Semaphores_pem4f.xdc.inc

clean,em4f::
	-$(RM) Semaphores.pem4f
.executables,em4f .executables: Semaphores.xem4f

Semaphores.xem4f: |Semaphores.pem4f

-include package/cfg/Semaphores.xem4f.mak
Semaphores.xem4f: package/cfg/Semaphores_pem4f.oem4f 
	$(RM) $@
	@$(MSG) lnkem4f $@ ...
	$(RM) $(XDCCFGDIR)/$@.map
	$(ti.targets.arm.elf.M4F.rootDir)/bin/armcl -fs $(XDCCFGDIR)$(dir $@). -q -u _c_int00 --silicon_version=7M4 -z --strict_compatibility=on  -o $@ package/cfg/Semaphores_pem4f.oem4f   package/cfg/Semaphores_pem4f.xdl  -w -c -m $(XDCCFGDIR)/$@.map -l $(ti.targets.arm.elf.M4F.rootDir)/lib/libc.a
	
Semaphores.xem4f: export C_DIR=
Semaphores.xem4f: PATH:=$(ti.targets.arm.elf.M4F.rootDir)/bin/;$(PATH)
Semaphores.xem4f: Path:=$(ti.targets.arm.elf.M4F.rootDir)/bin/;$(PATH)

Semaphores.test test,em4f test: Semaphores.xem4f.test

Semaphores.xem4f.test:: Semaphores.xem4f
ifeq (,$(_TESTLEVEL))
	@$(MAKE) -R -r --no-print-directory -f $(XDCROOT)/packages/xdc/bld/xdc.mak _TESTLEVEL=1 Semaphores.xem4f.test
else
	@$(MSG) running $<  ...
	$(call EXEC.Semaphores.xem4f, ) 
endif

clean,em4f::
	-$(RM) $(wildcard .tmp,Semaphores.xem4f,*)
...
%,copy:
	...
	$(RM) $@
	$(CP) $< $@
Semaphores_pem4f.oem4f,copy : package/cfg/Semaphores_pem4f.oem4f
Semaphores_pem4f.sem4f,copy : package/cfg/Semaphores_pem4f.sem4f

$(XDCCFGDIR)%.c $(XDCCFGDIR)%.h $(XDCCFGDIR)%.xdl: $(XDCCFGDIR)%.cfg $(XDCROOT)/packages/xdc/cfg/Main.xs | .interfaces
	@$(MSG) "configuring $(_PROG_NAME) from $< ..."
	$(CONFIG) $(_PROG_XSOPTS) xdc.cfg $(_PROG_NAME) $(XDCCFGDIR)$*.cfg $(XDCCFGDIR)$*

.PHONY: release,xconfig_Semaphores
ifeq (,$(MK_NOGENDEPS))
-include package/rel/xconfig_Semaphores.tar.dep
endif
package/rel/xconfig_Semaphores/xconfig_Semaphores/package/package.rel.xml: package/package.bld.xml
package/rel/xconfig_Semaphores/xconfig_Semaphores/package/package.rel.xml: package/build.cfg
package/rel/xconfig_Semaphores/xconfig_Semaphores/package/package.rel.xml: package/package.xdc.inc
package/rel/xconfig_Semaphores/xconfig_Semaphores/package/package.rel.xml: .force
	@$(MSG) generating external release references $@ ...
	$(XS) $(JSENV) -f $(XDCROOT)/packages/xdc/bld/rel.js $(MK_RELOPTS) . $@

xconfig_Semaphores.tar: package/rel/xconfig_Semaphores.xdc.inc package/rel/xconfig_Semaphores/xconfig_Semaphores/package/package.rel.xml
	@$(MSG) making release file $@ "(because of $(firstword $?))" ...
	-$(RM) $@
	$(call MKRELTAR,package/rel/xconfig_Semaphores.xdc.inc,package/rel/xconfig_Semaphores.tar.dep)


release release,xconfig_Semaphores: all xconfig_Semaphores.tar
clean:: .clean
	-$(RM) xconfig_Semaphores.tar
	-$(RM) package/rel/xconfig_Semaphores.xdc.inc
	-$(RM) package/rel/xconfig_Semaphores.tar.dep
