...
override PKGDIR = xconfig_watchdog
...
package/%.xdc.inc package/%_xconfig_watchdog.c package/%.defs.h: %.xdc $(PKGCFGS)
	@$(MSG) generating interfaces for package xconfig_watchdog" (because $@ is older than $(firstword $?))" ...
	$(XSRUN) -f xdc/services/intern/cmd/build.xs $(MK_IDLOPTS) -m package/package.xdc.dep -i package/package.xdc.inc package.xdc

.dlls,em4f .dlls: watchdog.pem4f

-include package/cfg/watchdog_pem4f.mak
-include package/cfg/watchdog_pem4f.cfg.mak
ifeq (,$(MK_NOGENDEPS))
-include package/cfg/watchdog_pem4f.dep
endif
watchdog.pem4f: package/cfg/watchdog_pem4f.xdl
	@


ifeq (,$(wildcard .libraries,em4f))
watchdog.pem4f package/cfg/watchdog_pem4f.c: .libraries,em4f
endif

package/cfg/watchdog_pem4f.c package/cfg/watchdog_pem4f.h package/cfg/watchdog_pem4f.xdl: override _PROG_NAME := watchdog.xem4f
package/cfg/watchdog_pem4f.c: package/cfg/watchdog_pem4f.cfg
package/cfg/watchdog_pem4f.xdc.inc: package/cfg/watchdog_pem4f.xdl
package/cfg/watchdog_pem4f.xdl package/cfg/watchdog_pem4f.c: .interfaces

clean:: clean,em4f
	-$(RM) package/cfg/watchdog_pem4f.cfg
	-$(RM) package/cfg/watchdog_pem4f.dep
	-$(RM) package/cfg/watchdog_pem4f.c
	-$(RM) package/cfg/watchdog_pem4f.xdc.inc

clean,em4f::
	-$(RM) watchdog.pem4f
.executables,em4f .executables: watchdog.xem4f

watchdog.xem4f: |watchdog.pem4f

-include package/cfg/watchdog.xem4f.mak
watchdog.xem4f: package/cfg/watchdog_pem4f.oem4f 
	$(RM) $@
	@$(MSG) lnkem4f $@ ...
	$(RM) $(XDCCFGDIR)/$@.map
	$(ti.targets.arm.elf.M4F.rootDir)/bin/armcl -fs $(XDCCFGDIR)$(dir $@). -q -u _c_int00 --silicon_version=7M4 -z --strict_compatibility=on  -o $@ package/cfg/watchdog_pem4f.oem4f   package/cfg/watchdog_pem4f.xdl  -w -c -m $(XDCCFGDIR)/$@.map -l $(ti.targets.arm.elf.M4F.rootDir)/lib/libc.a
	
watchdog.xem4f: export C_DIR=
watchdog.xem4f: PATH:=$(ti.targets.arm.elf.M4F.rootDir)/bin/;$(PATH)
watchdog.xem4f: Path:=$(ti.targets.arm.elf.M4F.rootDir)/bin/;$(PATH)

watchdog.test test,em4f test: watchdog.xem4f.test

watchdog.xem4f.test:: watchdog.xem4f
ifeq (,$(_TESTLEVEL))
	@$(MAKE) -R -r --no-print-directory -f $(XDCROOT)/packages/xdc/bld/xdc.mak _TESTLEVEL=1 watchdog.xem4f.test
else
	@$(MSG) running $<  ...
	$(call EXEC.watchdog.xem4f, ) 
endif

clean,em4f::
	-$(RM) $(wildcard .tmp,watchdog.xem4f,*)
...
%,copy:
	...
	$(RM) $@
	$(CP) $< $@
watchdog_pem4f.oem4f,copy : package/cfg/watchdog_pem4f.oem4f
watchdog_pem4f.sem4f,copy : package/cfg/watchdog_pem4f.sem4f

$(XDCCFGDIR)%.c $(XDCCFGDIR)%.h $(XDCCFGDIR)%.xdl: $(XDCCFGDIR)%.cfg $(XDCROOT)/packages/xdc/cfg/Main.xs | .interfaces
	@$(MSG) "configuring $(_PROG_NAME) from $< ..."
	$(CONFIG) $(_PROG_XSOPTS) xdc.cfg $(_PROG_NAME) $(XDCCFGDIR)$*.cfg $(XDCCFGDIR)$*

.PHONY: release,xconfig_watchdog
ifeq (,$(MK_NOGENDEPS))
-include package/rel/xconfig_watchdog.tar.dep
endif
package/rel/xconfig_watchdog/xconfig_watchdog/package/package.rel.xml: package/package.bld.xml
package/rel/xconfig_watchdog/xconfig_watchdog/package/package.rel.xml: package/build.cfg
package/rel/xconfig_watchdog/xconfig_watchdog/package/package.rel.xml: package/package.xdc.inc
package/rel/xconfig_watchdog/xconfig_watchdog/package/package.rel.xml: .force
	@$(MSG) generating external release references $@ ...
	$(XS) $(JSENV) -f $(XDCROOT)/packages/xdc/bld/rel.js $(MK_RELOPTS) . $@

xconfig_watchdog.tar: package/rel/xconfig_watchdog.xdc.inc package/rel/xconfig_watchdog/xconfig_watchdog/package/package.rel.xml
	@$(MSG) making release file $@ "(because of $(firstword $?))" ...
	-$(RM) $@
	$(call MKRELTAR,package/rel/xconfig_watchdog.xdc.inc,package/rel/xconfig_watchdog.tar.dep)


release release,xconfig_watchdog: all xconfig_watchdog.tar
clean:: .clean
	-$(RM) xconfig_watchdog.tar
	-$(RM) package/rel/xconfig_watchdog.xdc.inc
	-$(RM) package/rel/xconfig_watchdog.tar.dep
