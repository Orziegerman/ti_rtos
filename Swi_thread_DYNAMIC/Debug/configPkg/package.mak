...
.dlls,em4f .dlls: Swi_thread_DYNAMIC.pem4f

-include package/cfg/Swi_thread_DYNAMIC_pem4f.mak
-include package/cfg/Swi_thread_DYNAMIC_pem4f.cfg.mak
ifeq (,$(MK_NOGENDEPS))
-include package/cfg/Swi_thread_DYNAMIC_pem4f.dep
endif
Swi_thread_DYNAMIC.pem4f: package/cfg/Swi_thread_DYNAMIC_pem4f.xdl
	@


ifeq (,$(wildcard .libraries,em4f))
Swi_thread_DYNAMIC.pem4f package/cfg/Swi_thread_DYNAMIC_pem4f.c: .libraries,em4f
endif

package/cfg/Swi_thread_DYNAMIC_pem4f.c package/cfg/Swi_thread_DYNAMIC_pem4f.h package/cfg/Swi_thread_DYNAMIC_pem4f.xdl: override _PROG_NAME := Swi_thread_DYNAMIC.xem4f
package/cfg/Swi_thread_DYNAMIC_pem4f.c: package/cfg/Swi_thread_DYNAMIC_pem4f.cfg
package/cfg/Swi_thread_DYNAMIC_pem4f.xdc.inc: package/cfg/Swi_thread_DYNAMIC_pem4f.xdl
package/cfg/Swi_thread_DYNAMIC_pem4f.xdl package/cfg/Swi_thread_DYNAMIC_pem4f.c: .interfaces

clean:: clean,em4f
	-$(RM) package/cfg/Swi_thread_DYNAMIC_pem4f.cfg
	-$(RM) package/cfg/Swi_thread_DYNAMIC_pem4f.dep
	-$(RM) package/cfg/Swi_thread_DYNAMIC_pem4f.c
	-$(RM) package/cfg/Swi_thread_DYNAMIC_pem4f.xdc.inc

clean,em4f::
	-$(RM) Swi_thread_DYNAMIC.pem4f
.executables,em4f .executables: Swi_thread_DYNAMIC.xem4f

Swi_thread_DYNAMIC.xem4f: |Swi_thread_DYNAMIC.pem4f

-include package/cfg/Swi_thread_DYNAMIC.xem4f.mak
Swi_thread_DYNAMIC.xem4f: package/cfg/Swi_thread_DYNAMIC_pem4f.oem4f 
	$(RM) $@
	@$(MSG) lnkem4f $@ ...
	$(RM) $(XDCCFGDIR)/$@.map
	$(ti.targets.arm.elf.M4F.rootDir)/bin/armcl -fs $(XDCCFGDIR)$(dir $@). -q -u _c_int00 --silicon_version=7M4 -z --strict_compatibility=on  -o $@ package/cfg/Swi_thread_DYNAMIC_pem4f.oem4f   package/cfg/Swi_thread_DYNAMIC_pem4f.xdl  -w -c -m $(XDCCFGDIR)/$@.map -l $(ti.targets.arm.elf.M4F.rootDir)/lib/libc.a
	
Swi_thread_DYNAMIC.xem4f: export C_DIR=
Swi_thread_DYNAMIC.xem4f: PATH:=$(ti.targets.arm.elf.M4F.rootDir)/bin/;$(PATH)
Swi_thread_DYNAMIC.xem4f: Path:=$(ti.targets.arm.elf.M4F.rootDir)/bin/;$(PATH)

Swi_thread_DYNAMIC.test test,em4f test: Swi_thread_DYNAMIC.xem4f.test

Swi_thread_DYNAMIC.xem4f.test:: Swi_thread_DYNAMIC.xem4f
ifeq (,$(_TESTLEVEL))
	@$(MAKE) -R -r --no-print-directory -f $(XDCROOT)/packages/xdc/bld/xdc.mak _TESTLEVEL=1 Swi_thread_DYNAMIC.xem4f.test
else
	@$(MSG) running $<  ...
	$(call EXEC.Swi_thread_DYNAMIC.xem4f, ) 
endif

clean,em4f::
	-$(RM) $(wildcard .tmp,Swi_thread_DYNAMIC.xem4f,*)


clean:: clean,em4f

clean,em4f::
	-$(RM) Swi_thread_DYNAMIC.xem4f
%,copy:
	@$(if $<,,$(MSG) don\'t know how to build $*; exit 1)
	@$(MSG) cp $< $@
	$(RM) $@
	$(CP) $< $@
Swi_thread_DYNAMIC_pem4f.oem4f,copy : package/cfg/Swi_thread_DYNAMIC_pem4f.oem4f
Swi_thread_DYNAMIC_pem4f.sem4f,copy : package/cfg/Swi_thread_DYNAMIC_pem4f.sem4f
