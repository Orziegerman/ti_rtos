...
override PKGDIR = xconfig_Multi_Thread
...
package/%.xdc.inc package/%_xconfig_Multi_Thread.c package/%.defs.h: %.xdc $(PKGCFGS)
	@$(MSG) generating interfaces for package xconfig_Multi_Thread" (because $@ is older than $(firstword $?))" ...
	$(XSRUN) -f xdc/services/intern/cmd/build.xs $(MK_IDLOPTS) -m package/package.xdc.dep -i package/package.xdc.inc package.xdc

.dlls,em4f .dlls: Multi-Thread.pem4f

-include package/cfg/Multi-Thread_pem4f.mak
-include package/cfg/Multi-Thread_pem4f.cfg.mak
ifeq (,$(MK_NOGENDEPS))
-include package/cfg/Multi-Thread_pem4f.dep
endif
Multi-Thread.pem4f: package/cfg/Multi-Thread_pem4f.xdl
	@


ifeq (,$(wildcard .libraries,em4f))
Multi-Thread.pem4f package/cfg/Multi-Thread_pem4f.c: .libraries,em4f
endif

package/cfg/Multi-Thread_pem4f.c package/cfg/Multi-Thread_pem4f.h package/cfg/Multi-Thread_pem4f.xdl: override _PROG_NAME := Multi-Thread.xem4f
package/cfg/Multi-Thread_pem4f.c: package/cfg/Multi-Thread_pem4f.cfg
package/cfg/Multi-Thread_pem4f.xdc.inc: package/cfg/Multi-Thread_pem4f.xdl
package/cfg/Multi-Thread_pem4f.xdl package/cfg/Multi-Thread_pem4f.c: .interfaces

clean:: clean,em4f
	-$(RM) package/cfg/Multi-Thread_pem4f.cfg
	-$(RM) package/cfg/Multi-Thread_pem4f.dep
	-$(RM) package/cfg/Multi-Thread_pem4f.c
	-$(RM) package/cfg/Multi-Thread_pem4f.xdc.inc

clean,em4f::
	-$(RM) Multi-Thread.pem4f
.executables,em4f .executables: Multi-Thread.xem4f

Multi-Thread.xem4f: |Multi-Thread.pem4f

-include package/cfg/Multi-Thread.xem4f.mak
Multi-Thread.xem4f: package/cfg/Multi-Thread_pem4f.oem4f 
	$(RM) $@
	@$(MSG) lnkem4f $@ ...
	$(RM) $(XDCCFGDIR)/$@.map
	$(ti.targets.arm.elf.M4F.rootDir)/bin/armcl -fs $(XDCCFGDIR)$(dir $@). -q -u _c_int00 --silicon_version=7M4 -z --strict_compatibility=on  -o $@ package/cfg/Multi-Thread_pem4f.oem4f   package/cfg/Multi-Thread_pem4f.xdl  -w -c -m $(XDCCFGDIR)/$@.map -l $(ti.targets.arm.elf.M4F.rootDir)/lib/libc.a
	
Multi-Thread.xem4f: export C_DIR=
Multi-Thread.xem4f: PATH:=$(ti.targets.arm.elf.M4F.rootDir)/bin/;$(PATH)
Multi-Thread.xem4f: Path:=$(ti.targets.arm.elf.M4F.rootDir)/bin/;$(PATH)

Multi-Thread.test test,em4f test: Multi-Thread.xem4f.test

Multi-Thread.xem4f.test:: Multi-Thread.xem4f
ifeq (,$(_TESTLEVEL))
	@$(MAKE) -R -r --no-print-directory -f $(XDCROOT)/packages/xdc/bld/xdc.mak _TESTLEVEL=1 Multi-Thread.xem4f.test
else
	@$(MSG) running $<  ...
	$(call EXEC.Multi-Thread.xem4f, ) 
endif

clean,em4f::
	-$(RM) $(wildcard .tmp,Multi-Thread.xem4f,*)


clean:: clean,em4f

clean,em4f::
	-$(RM) Multi-Thread.xem4f
%,copy:
	@$(if $<,,$(MSG) don\'t know how to build $*; exit 1)
	@$(MSG) cp $< $@
	$(RM) $@
	$(CP) $< $@
Multi-Thread_pem4f.oem4f,copy : package/cfg/Multi-Thread_pem4f.oem4f
Multi-Thread_pem4f.sem4f,copy : package/cfg/Multi-Thread_pem4f.sem4f

$(XDCCFGDIR)%.c $(XDCCFGDIR)%.h $(XDCCFGDIR)%.xdl: $(XDCCFGDIR)%.cfg $(XDCROOT)/packages/xdc/cfg/Main.xs | .interfaces
	@$(MSG) "configuring $(_PROG_NAME) from $< ..."
	$(CONFIG) $(_PROG_XSOPTS) xdc.cfg $(_PROG_NAME) $(XDCCFGDIR)$*.cfg $(XDCCFGDIR)$*

.PHONY: release,xconfig_Multi_Thread
ifeq (,$(MK_NOGENDEPS))
-include package/rel/xconfig_Multi_Thread.tar.dep
endif
package/rel/xconfig_Multi_Thread/xconfig_Multi_Thread/package/package.rel.xml: package/package.bld.xml
package/rel/xconfig_Multi_Thread/xconfig_Multi_Thread/package/package.rel.xml: package/build.cfg
package/rel/xconfig_Multi_Thread/xconfig_Multi_Thread/package/package.rel.xml: package/package.xdc.inc
package/rel/xconfig_Multi_Thread/xconfig_Multi_Thread/package/package.rel.xml: .force
	@$(MSG) generating external release references $@ ...
	$(XS) $(JSENV) -f $(XDCROOT)/packages/xdc/bld/rel.js $(MK_RELOPTS) . $@

xconfig_Multi_Thread.tar: package/rel/xconfig_Multi_Thread.xdc.inc package/rel/xconfig_Multi_Thread/xconfig_Multi_Thread/package/package.rel.xml
	@$(MSG) making release file $@ "(because of $(firstword $?))" ...
	-$(RM) $@
	$(call MKRELTAR,package/rel/xconfig_Multi_Thread.xdc.inc,package/rel/xconfig_Multi_Thread.tar.dep)


release release,xconfig_Multi_Thread: all xconfig_Multi_Thread.tar
clean:: .clean
	-$(RM) xconfig_Multi_Thread.tar
	-$(RM) package/rel/xconfig_Multi_Thread.xdc.inc
	-$(RM) package/rel/xconfig_Multi_Thread.tar.dep
